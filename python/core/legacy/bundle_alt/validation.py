...
from core.legacy.bundle_alt.predicates import has_requires, is_component, is_component_key, is_service
from core.legacy.bundle_alt.representation import dependency_entry_to_key, repr_from_key
